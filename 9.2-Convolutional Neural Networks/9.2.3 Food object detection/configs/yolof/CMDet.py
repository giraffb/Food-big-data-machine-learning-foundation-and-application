...
# optimizer
optim_wrapper = dict(
    optimizer=dict(type='SGD', lr=0.024, momentum=0.9),
...
train_dataloader = dict(
    batch_size=24, num_workers=8, dataset=dict(pipeline=train_pipeline))
val_dataloader = dict(batch_size=24, num_workers=8, dataset=dict(pipeline=test_pipeline))
...
work_dir = './work_dirs/CMDet_ZSFood_no_depth_branch_2EAM'
