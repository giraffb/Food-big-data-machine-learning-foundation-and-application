...
class customPackDetInputs(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        ...
        if 'img' in results:
            ...
            if not img.flags.c_contiguous:
                ...
                # img_d = np.ascontiguousarray(img_d.transpose(2, 0, 1))
                ...
                img_d = to_tensor(img_d).contiguous()
            # print(img_d.shape)

            # print(img_d.shape)
            packed_results['inputs'] = img
            packed_results['inputs_d'] = img_d
